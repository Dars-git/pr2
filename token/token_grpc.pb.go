...
type TokenServiceClient interface {
	CreateToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenResponse, error)
	DropToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenResponse, error)
	WriteToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenResponse, error)
	ReadToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenResponse, error)
}
...
func (c *tokenServiceClient) CreateToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenResponse, error) {
...
func (c *tokenServiceClient) DropToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenResponse, error) {
	out := new(TokenResponse)
...
func (c *tokenServiceClient) WriteToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenResponse, error) {
	out := new(TokenResponse)
...
func (c *tokenServiceClient) ReadToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenResponse, error) {
	out := new(TokenResponse)
...
type TokenServiceServer interface {
	CreateToken(context.Context, *Token) (*TokenResponse, error)
	DropToken(context.Context, *Token) (*TokenResponse, error)
	WriteToken(context.Context, *Token) (*TokenResponse, error)
	ReadToken(context.Context, *Token) (*TokenResponse, error)
...
func (UnimplementedTokenServiceServer) CreateToken(context.Context, *Token) (*TokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateToken not implemented")
}
func (UnimplementedTokenServiceServer) DropToken(context.Context, *Token) (*TokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DropToken not implemented")
}
func (UnimplementedTokenServiceServer) WriteToken(context.Context, *Token) (*TokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WriteToken not implemented")
}
func (UnimplementedTokenServiceServer) ReadToken(context.Context, *Token) (*TokenResponse, error) {
